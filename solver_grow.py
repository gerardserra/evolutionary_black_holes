...
class Solver(object):
    def __init__(self,rings,population):
        ...
        self.initialMeans = np.random.uniform(low=1, high=1.5, size=(self.rings,))
       ...
       # self.es = cma.CMAEvolutionStrategy(self.initialMeans, self.initialSigma, {'popsize': self.population,'bounds': [1, 1.25]})
        self.es = cma.CMAEvolutionStrategy(self.initialMeans, self.initialSigma, {'popsize': self.population,'bounds': [1, 1.5]})
