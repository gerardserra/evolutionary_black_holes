...
function test_growing(total,maxGen,totalPop,cutFreq)
...
while not(endExperiment)
    [experimentBestProposals{end+1},experimentBestFits{end+1},experimentBestShapes{end+1},experimentCandidates{end+1},experimentFitness{end+1}]= ABH_test(40,maxGen,totalPop,cutFreq);
